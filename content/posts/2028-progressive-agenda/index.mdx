...
Ezra Klein and Derek Thompson made this case powerfully — that America has forgotten how to build, that progressives in particular have become associated with restriction and process rather than creation and results.<FootnoteRef id={11} /> They're right. But Klein and Thompson were writing as journalists describing a framework. The political question is: who owns it?
...
<Footnote id={11}>Ezra Klein and Derek Thompson, *Abundance: On Freedom and the Fear of Too Much* (Avid Reader Press, 2025). Klein and Thompson argue that America's inability to build is driven by progressive-aligned regulatory accumulation that prioritizes process over outcomes.</Footnote>
