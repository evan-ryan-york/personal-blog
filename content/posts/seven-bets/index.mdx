...
status: "draft"
tldr:
  - "Everyone is already betting on AI, whether or not they've written the bets down. These are mine, written down."
  - "Software stops being an object and starts running a loop: sensing, growing, pruning inside a garden humans design."
  - "Entrepreneurship becomes the default shape of human work, and holding the people who do it means employment has to carry equity."
  - "Agents take the work with knowable answers, so almost everyone becomes a manager of agents. Leverage is how many you can direct and answer for."
  - "Capabilities get copied. What compounds is long-term memory, so buy and build for what a system remembers about you."
  - "Digital timelines don't transfer to atoms: believe the software half of any abundance forecast, add a decade to the physical half."
  - "Energy is the defining buildout of the decade, and the constraint is shifting from producing electrons to moving them."
  - "Abundance reaches the wealthy first and the bill lands on everyone else unless the distribution is forced. That's the one bet I want to lose."
---
...
Everyone may get extraordinary intelligence. Not everyone will automatically get the capacity to do something with it.
...
Technology can create abundance. It cannot decide how abundance is distributed.
