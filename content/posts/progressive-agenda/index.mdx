...
status: "published"
tldr:
  - "The problem: Progressives have moral clarity about distribution and no credible theory of how prosperity gets made. That gap is why they walk into the midterms and 2028 unprepared."
  - "The distinction: Artificial intelligence is not the companies currently building it. Opposing those companies' behavior is not the same as opposing the technology, and conflating the two forfeits the most powerful engine of abundance ever built."
  - "The empty quadrant: Plot an abundance agenda against equitable distribution and four positions appear. Republicans hold free-market theory with protectionist reality. Progressives hold moral clarity with no engine. The soft center holds neither. The quadrant where a movement builds everything and shares everything is empty."
  - "The platform: Treat AI as a strategic national priority on par with the interstate highway system, paired with structural accountability — if you profit from AI, you fund what AI reshapes. Carbon standards with co-investment, rural construction, water recycling, and reinvestment minimums so host communities share in what gets produced."
  - "The stakes: Abundance reaches the wealthy first unless equity shapes what gets built, who owns it, and who shares in its value from the beginning."
---
...
This is a problem. And it's solvable. It rests on a reading of where AI actually goes over the next ten years, which I've laid out separately as [seven bets](/posts/seven-bets). But solving it requires the progressive movement to do something uncomfortable: **fully embrace artificial intelligence as the most powerful engine of abundance in the history of humankind, while simultaneously demanding — with real teeth — that the abundance it creates is equitably shared.**
...
Universal pre-K, subsidized childcare, and free public higher education — and, past the funding question, [a school design worth funding](/posts/plane-never-flying) — paid for by an automation-adjusted corporate tax that scales with how aggressively a company replaces workers with AI. If your labor share of revenue drops below a threshold, your rate goes up, and that revenue funds the system that prepares the next workforce. If you're profiting from a workforce you no longer need, you fund the one that comes next.
