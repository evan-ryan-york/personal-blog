...
<p>You'll get an email the next time I post something, and in the meantime, check out my existing work at <a href="${siteUrl}">ryanyork.io</a>.</p>
<p>— Ryan</p>`,
          text: `Hey there!\n\nThanks for taking the time to subscribe. This is my own personal sandbox, where I write about the insights I gather from working across multiple sectors and industries, and my theories about how those insights should shape the world.\n\nYou'll get an email the next time I post something, and in the meantime, check out my existing work at ${siteUrl}.\n\n— Ryan`,
        });
      } catch (emailError) {
